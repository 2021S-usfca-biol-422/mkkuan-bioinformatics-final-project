...
```
**Figure 2** The frequencies of the quality scores from Shanghai data. Quality scores less than 200 are not of high quality.
...
**Table 2**: Frequency of each SNP position. The highest frequency was the SNPs in position 28144 and 8782. SNPs with frequencies less than five were removed from the table. 
